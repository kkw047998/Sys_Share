        ...
        if($rep_type=='handler'){       
            ...
            for($h=0;$h<count($handler);$h++){
                ...
                while($row_user = mysqli_fetch_array($result_user)){
                    ...
                    Please visit <u><a href='https://portal.bsc.edu.hk/systems/UI/index.php?etype=req&req_view=handler&req_id=".$select_id."#/RequestPortal/ticket' target='_blank'>Here</a></u> for more information.
                    <br><br>
                    PS: <b>Please do not reply to this email as this is an auto email function featured by Request System</b>";
                    $mail->AddAddress($recMail);
                    $mail->Send();
