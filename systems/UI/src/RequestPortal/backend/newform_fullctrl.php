...
$sql_maxref = "SELECT MAX(ref_id) as maxref FROM request_portal WHERE period='$period'";
$result_maxref = $db->query($sql_maxref);
$row_maxref = mysqli_fetch_array($result_maxref);
$maxref = intval($row_maxref['maxref'])+1;
$sql_insert = "
INSERT request_portal(ref_id,Period,Requester,Req_Name,Req_Mail,Request_for,Description,Category,Due_date,Due_time,Location,Remarks,Status,Handler,Creation_dt)
VALUES ('$maxref','$period','$recid','$recName','$recMail','$rf','$Dp','$Cat','$Dd','$Dt','$Loc','$R','$St','$Handler_name','$creation_date') 
;
";	
