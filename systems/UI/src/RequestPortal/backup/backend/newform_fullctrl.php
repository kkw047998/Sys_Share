...
$sql_insert = "
INSERT request_portal(Requester,Req_Name,Req_Mail,Request_for,Description,Category,Due_date,Due_time,Location,Remarks,Status,Handler)
VALUES ('$recid','$recName','$recMail','$rf','$Dp','$Cat','$Dd','$Dt','$Loc','$R','$St',UPPER('$Handler_name')) 
;
";	
