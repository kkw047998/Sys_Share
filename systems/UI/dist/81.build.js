...
exports.default = {
    ...
    methods: {
        check_status: function check_status() {
            ...
            _axios2.default.post("Procurement/procurement/backend/edit_mode.php", formData).then(function (response) {
                _this2.edit_mode = response.data;
            });
        },
        ...
        next_step: async function next_step() {
            ...
            await _axios2.default.post('Procurement/procurement/backend/fetch_edit_proc_item_cost.php', formData_fetch).then(function (response) {
                ...
                for (ini = 0; ini < c + 1; ini++) {
                    for (oc = 0; oc < _this4.counter_item + 1; oc++) {
                        _this4.cost_item[ini][oc] = 0;
                        _this4.cost_total[ini][oc] = Number(_this4.quantity[l]) * 0;
                    }
                }
                for (k = 0; k < c + 1; k++) {
                    for (l = 0; l < _this4.old_counter_item + 1; l++) {
                        _this4.cost_item[k][l] = Number(_this4.fetch_item[n].unit_cost);
                        _this4.cost_total[k][l] = Number(_this4.quantity[l]) * _this4.cost_item[k][l];
                        n++;
                    }
                }
            });
        ...
        handleSubmit: async function handleSubmit() {
            ...
            if (this.edit_mode == 'regular') {
                await _axios2.default.post('Procurement/procurement/backend/edit_new_proc.php', formData).then(function (response) {
                    _this6.$alert('Successfully Submitted !').then(function () {
                        _this6.processing = false;
                    });
                    _this6.$router.push('view_proc');
                });
            } else if (this.edit_mode == 'twqa') {
                await _axios2.default.post('Procurement/procurement/backend/twqa_update_proc.php', formData).then(function (response) {
                    _this6.$alert('Successfully Submitted !').then(function () {
                        _this6.processing = false;
                    });
                    _this6.$router.push('view_proc');
...
var update = __webpack_require__(5)("7017052c", content, true, {});
...
// module
exports.push([module.i, ".input-group-addon[data-v-4e3be45a]{background-color:transparent;border-left:0}input[type=date][data-v-4e3be45a]::-webkit-inner-spin-button{-webkit-appearance:none;display:none}", ""]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_edit_proc_vue__ = __webpack_require__(1230);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_edit_proc_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_edit_proc_vue__);
/* harmony namespace reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_edit_proc_vue__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_edit_proc_vue__[key]; }) }(__WEBPACK_IMPORT_KEY__));
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_4e3be45a_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_edit_proc_vue__ = __webpack_require__(1481);
...
/* scopeId */
var __vue_scopeId__ = "data-v-4e3be45a"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_edit_proc_vue___default.a,
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_4e3be45a_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_edit_proc_vue__["a" /* default */],
...
//# sourceMappingURL=81.build.js.map