...
exports.default = {
    ...
    created: async function created() {
        ...
        await _axios2.default.get('Procurement/procurement/backend/TWQA_permission.php').then(function (response) {
    ...
    methods: {
        post_ssc: function post_ssc(event) {
            ...
            _axios2.default.post('Procurement/reimbursement/backend/check_sign.php', formData).then(function (response) {
                _this2.sign_data = response.data;
            ...
            if (key == '') {
                ...
                _axios2.default.post('Procurement/procurement/backend/search_user.php', formData).then(function (response) {
                    if (!(response.data == 'Empty')) {
                        _this3.hv_user = true;
                        _this3.user_list = response.data;
                    } else {
                        _this3.user_list = '';
        ...
        next_step: async function next_step() {
            ...
            await _axios2.default.post('Procurement/procurement/backend/fetch_edit_proc_item_cost.php', formData_fetch).then(function (response) {
                _this4.fetch_item = response.data;
                var k = 0;
                var l = 0;
                var n = 0;
                var c = 0;
                if (_this4.counter_old > _this4.counter_company) {
                    c = _this4.counter_company;
                } else {
                    c = _this4.counter_old;
                }
                for (k = 0; k < c + 1; k++) {
                    for (l = 0; l < _this4.counter_item + 1; l++) {
                        _this4.cost_item[k][l] = Number(_this4.fetch_item[n].unit_cost);
                        _this4.cost_total[k][l] = Number(_this4.fetch_item[n].quantity) * _this4.cost_item[k][l];
                        n++;
                    }
                }
            });
        ...
        handleSubmit: async function handleSubmit() {
            ...
            if (this.signed == true) {
                ...
                await _axios2.default.post('Procurement/procurement/backend/edit_new_proc_sign.php', formData).then(function (response) {
...
var update = __webpack_require__(5)("384318aa", content, true, {});
...
// module
exports.push([module.i, ".input-group-addon[data-v-73ce5a8a]{background-color:transparent;border-left:0}input[type=date][data-v-73ce5a8a]::-webkit-inner-spin-button{-webkit-appearance:none;display:none}", ""]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_sign_code_vue__ = __webpack_require__(1240);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_sign_code_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_sign_code_vue__);
/* harmony namespace reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_sign_code_vue__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_sign_code_vue__[key]; }) }(__WEBPACK_IMPORT_KEY__));
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_73ce5a8a_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_sign_code_vue__ = __webpack_require__(1511);
...
/* scopeId */
var __vue_scopeId__ = "data-v-73ce5a8a"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_sign_code_vue___default.a,
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_73ce5a8a_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_sign_code_vue__["a" /* default */],
...
//# sourceMappingURL=72.build.js.map