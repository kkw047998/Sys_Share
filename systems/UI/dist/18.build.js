...
exports.default = {
    data: function data() {
        ...
        return _ref = {
            ...
            subdept: '',
            title: 'Admin',
            title_dep: ['superadmin', 'admin', 'Manager', 'Principal', 'Principal Secretary', 'PTA', 'Department Head', 'Committee Head', 'Secretary', 'Member'],
            search_user_key: "",
            userlist: [],
            dept_list: [],
            dept_list_name: [],
    ...
    created: async function created() {
        ...
        await axios.get('Procurement/shared_backend/alldept.php').then(function (response) {
            _this.dept_list = response.data;
            _this.dept = response.data[0].dept_id;
    ...
    methods: {
        ...
        fetch_sub_list: function fetch_sub_list() {
            ...
            if (this.subdept == this.dept) {
                ...
                formData.append('subdept', this.subdept);
                axios.post('Procurement/admin/backend/subdept_member.php', formData).then(function (response) {
                    if (response.data == 'empty') {
                        _this4.userlist = [];
                    } else {
...
var update = __webpack_require__(5)("2b9fea58", content, true, {});
...
// module
exports.push([module.i, ".click_row[data-v-587d1449]{cursor:pointer}.flex[data-v-587d1449]{display:flex;flex-direction:row}.px0[data-v-587d1449]{padding-left:0;padding-right:0}", ""]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_usermngt_vue__ = __webpack_require__(1199);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_usermngt_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_usermngt_vue__);
/* harmony namespace reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_usermngt_vue__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_usermngt_vue__[key]; }) }(__WEBPACK_IMPORT_KEY__));
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_587d1449_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_usermngt_vue__ = __webpack_require__(1400);
...
/* scopeId */
var __vue_scopeId__ = "data-v-587d1449"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_usermngt_vue___default.a,
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_587d1449_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_usermngt_vue__["a" /* default */],
