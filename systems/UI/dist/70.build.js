...
exports.default = {
    ...
    created: async function created() {
        ...
        await _axios2.default.post('Procurement/procurement/backend/fetch_edit_proc_counter.php', formData_fetch).then(function (response) {
            ...
            var ini = 0;
            for (ini = 0; ini < _this.counter_company; ini++) {
                _this.new_co[ini] = false;
            }
        });
    ...
    methods: {
        ...
        next_step: async function next_step() {
            ...
            await _axios2.default.post('Procurement/procurement/backend/fetch_edit_proc_item_cost.php', formData_fetch).then(function (response) {
                ...
                for (ini = 0; ini < c + 1; ini++) {
                    for (oc = 0; oc < _this3.counter_item + 1; oc++) {
                        _this3.cost_item[ini][oc] = 0;
                        _this3.cost_total[ini][oc] = Number(_this3.quantity[l]) * 0;
                    }
                }
                for (k = 0; k < c + 1; k++) {
                    for (l = 0; l < _this3.old_counter_item + 1; l++) {
                        _this3.cost_item[k][l] = Number(_this3.fetch_item[n].unit_cost);
                        _this3.cost_total[k][l] = Number(_this3.quantity[l]) * _this3.cost_item[k][l];
                        n++;
                    }
                }
            });
        ...
        handleSubmit: function handleSubmit() {
            ...
            _axios2.default.post('Procurement/procurement/backend/edit_new_proc.php', formData).then(function (response) {
...
var update = __webpack_require__(5)("5ed6cd14", content, true, {});
...
// module
exports.push([module.i, ".input-group-addon[data-v-0c830c6f]{background-color:transparent;border-left:0}input[type=date][data-v-0c830c6f]::-webkit-inner-spin-button{-webkit-appearance:none;display:none}", ""]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_view_only_vue__ = __webpack_require__(1246);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_view_only_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_view_only_vue__);
/* harmony namespace reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_view_only_vue__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_view_only_vue__[key]; }) }(__WEBPACK_IMPORT_KEY__));
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_0c830c6f_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_view_only_vue__ = __webpack_require__(1531);
...
/* scopeId */
var __vue_scopeId__ = "data-v-0c830c6f"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_view_only_vue___default.a,
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_0c830c6f_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_view_only_vue__["a" /* default */],
...
//# sourceMappingURL=70.build.js.map